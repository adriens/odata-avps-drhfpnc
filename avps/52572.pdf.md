...
Missions : Rattaché à la direction, le(la) chef(fe) de service "Ressources" a pour missions d'animer et d'encadrer le service en garantissant son fonctionnement optimal et sa performance en fonction des objectifs stratégiques fixés en matière RH, budgétaire, financière et gestion des achats de la direction.